      ...
      <div className=" section-width">
        <div className="bg-[url('/images/scorecard/bgcardmain.svg')] bg-cover text-white mt-10 sm:mt-20 rounded-lg">
          <div className="bg-[#203376] text-center py-1 rounded-lg">
            <span className="text-sm font-medium uppercase p-2">
        ...
        <div className="flex justify-center mt-10 bg-transparent rounded-t-lg bg-gradient-to-r from-[#203376] via-black to-[#203376] overflow-x-auto min-w-[800px]">
          <button
        ...
        {/* Scorecard */}
        <div className="bg-[#0F1A2D]  shadow-md mb-8 overflow-x-auto min-w-[800px] rounded-b-lg">
          <div className="flex items-center bg-[#0F1A2D] text-white px-6 py-4">
            ...
            <div className="text-sm">
              <span className="font-semibold">
                {(activeInnings === "home" ? homeInnings : awayInnings).Total}/
                {(activeInnings === "home" ? homeInnings : awayInnings).Wickets}
              </span>
              <span className="ml-2">
                ({(activeInnings === "home" ? homeInnings : awayInnings).Overs}{" "}
                Overs)
              </span>
            </div>
          </div>
        ...
        {/* Bowling Stats */}
        <div className="bg-blue-900 text-white rounded-lg mb-10 overflow-x-auto min-w-[800px]">
