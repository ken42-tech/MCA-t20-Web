...
const Table = ({role, PlayerData}) => {
  ...
  <div className="bg-[#F28C28] p-3 xl:p-6 font-bold text-black text-2xl md:text-3xl xl:text-4xl uppercase">{role}</div>
  <div className="bg-black text-white">
    {PlayerData.map((player, index) => (
      <div key={index} className='flex items-center justify-between border-b border-gray-700 py-2 px-3 xl:px-6'>
      <div
      ...
      >
        ...
        <Image
          src={role == "batsman" ? "/images/teams/meetmyteam/Layer_1 (1).svg" : role == "bowlers" ? "/images/teams/meetmyteam/svg8.svg" : role == "all rounders" ? "/images/teams/meetmyteam/Layer_1 (3).svg":"/images/teams/meetmyteam/Layer_1 (4).svg"}
          alt="bat"
          width={350}
          height={350}
