...
const Hero = () => {
  return (
    <>
      <div className="w-full bg-[url('/images/home/bg2.png')] bg-cover bg-center relative pt-36">
        {/* <Image
        ...
        /> */}
        <div className="section-width pt-40 pb-24">
          <div className="flex flex-col items-center sm:items-start gap-3 lg:gap-6">
            ...
            <p className="text-2xl md:text-3xl lg:text-5xl font-extrabold max-w-lg max-sm:text-center">
            ...
            <div className="w-full rounded-xl md:rounded-l-xl border md:border-[2.5px] border-[#E07E27] md:h-44 xl:h-60 h-32 overflow-hidden">
              ...
              >
                ...
                <div className="flex flex-col justify-between  py-1">
                  <p className="text-[#E07E27] text-[6px]  xl:text-sm leading-3">
                  ...
                  <p className="text-[6px] xl:text-sm leading-3">
                    AAkash Tigers
                  </p>
                </div>
              </div>
