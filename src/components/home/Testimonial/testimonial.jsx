    ...
    return (
        <>
            <div className="text-center py-12 bg-black">
                <h2 className="text-transparent bg-clip-text bg-text-gradient mb-12">Testimonials</h2>
            ...
            <div className="relative mx-12 md:mx-16 px-32 md:px-16 mt-8 mb-8">
                        ...
                        >
                            ...
                            <div className="flex items-center mt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#C7C9D1]">{testimonial.role}</p>
                                </div>
                            </div>
                        </div>
                    ))}
                ...
                <div className="absolute top-1/2 right-0 transform -translate-y-1/2">
                    <button
                        onClick={handleNext}
                        className="text-white bg-gray-700 rounded-xl p-2"
                    >
                        ❯
                    </button>
                </div>
