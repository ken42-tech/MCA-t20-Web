...
const ContactForm = () => {
  return (
    <div className="bg-[#090A0D] text-white min-h-screen flex justify-center items-center px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900 p-8 rounded-lg lg:col-span-2 custom-border card-background">
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
              <h1 className="col-span-4 md:col-span-3 custom-heading mb-4 border-r-0 md:border-r border-gray-600 pl-8">
                Ready to Build the Future?
                <br /> Let’s Make It Happen
              </h1>
              <p className="col-span-4 md:col-span-3 text-gray-400 mb-8 text-[20px] text-center md:text-left">
          ...
          <div className="grid grid-cols-1 gap-4 lg:col-span-1 pb-10 lg:pb-0">
            {/* First Card - Location */}
