  ...
  <div className="grid grid-cols-12 gap-4 px-8 pt-6 pb-6">
    <div className="col-span-7">
      ...
      >
        ...
        <br />
        Dive into the market without delay, utilizing
         our fully integrated tech
        stack that meshes seamlessly with your operations.
      </p>
    </div>
    <div className="relative flex items-center justify-center  px-2">
      <div className="h-full w-[0.1px] bg-gray-700"></div>
    </div>
    <div className="col-span-4 pl-4 flex items-center justify-start">
      <Link
        href="/get-started"
        className="text-white bg-blue-700 px-2 py-2 rounded-full"
        style={{ fontSize: "12px" }}
      >
        Customize Your Path
      </Link>
                ...
                <div className="flex-1 lg:max-w-[70%] rounded-xl border border-gray-700 flex flex-col">
  <div className="border-b border-gray-700">
    <Image
