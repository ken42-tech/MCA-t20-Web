...
const Hero = ({imgUrl, heading, subheading}) => {
  return (
    <div className="w-full relative flex justify-end py-14">
      ...
      />
      <div className="relative z-10  pt-8 h-full w-full flex-col overflow-hidden justify-between text-white flex gap-24 mt-52">
        <div className="w-full h-[60%] flex flex-col items-start justify-between bg-transparent gap-20">
          <div className="h-full flex flex-col gap-3 px-32">
